...
hour_val = data['Hour']
plt.plot(hour_val[:24],y_pred_logreg[:24],color='red',label = 'Day 1')
plt.plot(hour_val[25:48],y_pred_logreg[25:48],color='blue',label = 'Day 2')
plt.xlabel('Hour')
plt.ylabel('GhI prediction')
plt.legend(loc='best')
plt.show()


hour_val = data['Hour']
plt.plot(hour_val[:24],y_test[:24],color='red',label = 'test values')
plt.plot(hour_val[:24],y_pred_logreg[:24],color='blue',label = 'Predicted Value')
plt.xlabel('Hour')
...
hour_val = data['Hour']
plt.plot(hour_val[:24],y_pred_adareg[:24],color='red',label = 'Day 1')
plt.plot(hour_val[25:48],y_pred_adareg[25:48],color='blue',label = 'Day 2')
plt.xlabel('Hour')
plt.ylabel('GHI prediction')
plt.legend(loc='best')
plt.show()
